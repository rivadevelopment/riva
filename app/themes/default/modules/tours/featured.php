...
================================= -->
<section class="destination-area section--padding section-bg">
<div class="container">
...
<span class="sec__title_left heading-featured-style text-color-12"><?=T::crazy_deals;?></span>
<h1 class="sec__title_left heading-featured-style font-size-24 "><?=T::tours_packages;?></h1>
<p class="sec__title_left heading-featured-style text-gray font-size-16"><?=T::crazy_deals_desc;?></p>

<!--<h2 class="sec__title_left left-line" style="font-size:22px">-->
<!--   <span class="heading-featured-style text-color-12 ">Best</span> Popular Tours -->
<!--</h2>-->
