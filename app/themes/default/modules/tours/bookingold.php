                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="list-items list-items-2 py-3">
                                    <div class="row ">
                                        ...
                                        <div class="col-7 ">
                                           <?=$adults?> <?php if (!empty($adults)){ echo "- ". $currency." ".number_format($tour->b2c_price_adult * $adults,2); } ?>
                                        </div>
                                    </div>
                                     <div class="row ">
                                        <div class="col-5 ">
                                        ...
                                        <div class="col-7">
                                            <?=$childs?> <?php if (!empty($childs)){ echo "- ". $currency." ".number_format($tour->b2c_price_child * $childs,2); } ?>
                                        </div>
                                    </div>
                                     <div class="row ">
                                        <div class="col-5 ">
                                        ...
                                        <div class="col-7 ">
                                           <?=$infants?> <?php if (!empty($infants)){ echo "- ". $currency." ".number_format($tour->b2c_price_infant * $infants,2); } ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                if ($tour->taxType == "fixed" ) {
                                 ...
                                 <ul class="list-items list-items-2 pt-3">
                                     <hr>
                                    <li><span><?=T::subtotal?>:</span><?=$currency?> <?=number_format( $sub_total,2) ?> </li>
                                    <li><span><?=T::taxesandfees?>:</span><?=$currency?> <?=number_format( $totaltax,2) ?></li>
                                    <hr>
                                    <li style="font-size:16px"><span><?=T::totalprice?>:</span><strong><?=$currency?> <?=number_format(($sub_total+$totaltax),2);?> </strong></li>
                                </ul>
...
$booking['sub_total'] = number_format($sub_total,2);
$booking['total_tax'] = number_format($totaltax,2);
$booking['total_price'] = number_format(($sub_total+$totaltax),2); 
...
<input type="hidden" name="payload" value="<?= base64_encode(json_encode($booking)) ?>" />
            ...
            <script type="text/javascript">
                 ...
                 function submit_tabby_req() {
                    ...
                    var infant_travellers = $('.infant_travellers').val();
                        ...
                        success: function(data) {
                            ...
                            if(is_email_virified){
                              ...
                              var web_url = `<a href="`+parsData.web_url+`" class="nav-link  border p-2" style="background:#fff;">
                                        ...
                                        <img src="<?=root.theme_url?>assets/img/tabby-logo.png" alt="<?=$item->title ?>" class="img-fluid w-75">
