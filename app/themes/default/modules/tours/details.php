            ...
            <div id="description" class="page-scroll">
                  ...
                  <div class="col-lg-4 responsive-column">
                    <div class="single-tour-feature d-flex align-items-center mb-3">
                      ...
                      <div class="single-feature-titles">
                        ...
                        <span class="font-size-13"><?=$currency." ".number_format($tour->b2c_price_adult,2)?></span>
                      </div>
                    </div>
                    <!-- end single-tour-feature -->
                  </div>
              ...
              <div class="single-content-item padding-top-40px padding-bottom-40px">
                ...
                <!--<h3 class="title font-size-15 font-weight-medium pb-3">Highlights</h3>
                  ...
                  <!--border radius-round p-1-->
                  <hr>
                <div class="row mt-4 p-3 content_inc_exc" >
                  <?php if (!empty($tour->inclusions)) { ?>
                  <div class="col-lg-6 responsive-column">
                    <h3 class="title font-size-15 font-weight-medium pb-3 font-weight-bold"><?=T::tours_tour?> <?=T::tours_inclusions?></h3>
                    <ul class="list-items">
                  ...
                  <div class="col-lg-6 responsive-column">
                    <h3 class="title font-size-15 font-weight-medium pb-3 font-weight-bold"><?=T::tours_tour?> <?=T::tours_exclusions?></h3>
                    <ul class="list-items">
                ...
                <a href="javascript:void(0)" class="show_hide_inc_exc btn btn-outline-primary mb-3" data-content="toggle-text"><?=T::read_more?></a>
                <script>
                  $(document).ready(function () {
                   $(".show_hide_inc_exc").on("click", function () {
                       var txt_inc_exc = $(".content_inc_exc").hasClass('visible') ? '<?=T::read_more?>' : '<?=T::read_less?>';
                       $(".show_hide_inc_exc").text(txt_inc_exc);
                       $(".content_inc_exc").toggleClass("visible");
                   });
                  });
                </script>
                <style>
            ...
            <div id="map" class="page-scroll">
              <div class="single-content-item padding-top-40px padding-bottom-20px">
                ...
                <div class="amenities-feature-item pt-4">
                  <div class="row">
                    <iframe src="https://maps.google.com/maps?q=<?=$tour->latitude?>,<?=$tour->longitude?>&z=15&output=embed" width="100%" height="270" frameborder="0" style="border:0"></iframe>
                  </div>
                  <!-- end row -->
                </div>
              </div>
            ...
            <div class="sidebar single-content-sidebar mb-0">
              <div class="sidebar-widget single-content-widget">
                <div class="sidebar-widget-item">
                  <div class="sidebar-book-title-wrap mb-3 d-flex justify-content-center padding-top-50px">
                    <h3><?=T::price?></h3>
                    <p>
                      <span class="" style=""> &nbsp; <h3>(  <?=$currency?></h3> &nbsp;
                        <h3>
                          <span class="total">
                          <?php
                            // create clean vars
                ...
                <form action="<?=root?>tours/booking" method="post" autocomplete="off">
                  ...
                  <div class="sidebar-widget-item mt-3">
                    <div class="qty-box mb-2 d-flex align-items-center justify-content-between adult">
                      <label class="font-size-16" style="width:100px;"><?=T::adults?> <span><?=T::age?> 18+</span></label>
                      <label class="font-size-16" style="width:100px;"><?=T::price?> <span><?=$currency?> <?=number_format($tour->b2c_price_adult,2)?></span></label>
                    ...
                    <div class="qty-box mb-2 d-flex align-items-center justify-content-between child">
                      <label class="font-size-16" style="width:100px;"><?=T::child?> <span><?=T::age?> 2 to 17 </span></label>
                      <label class="font-size-16" style="width:100px;"><?=T::price?> <span><?=$currency?> <?=$tour->b2c_price_child?></span></label>
                      <div class="d-flex align-items-center">
                        <select name="childs" id="childs" class="childs form-select" <?php if($c_price == 0 ) {echo 'disabled';} ?>>
                    ...
                    <div class="qty-box mb-2 d-flex align-items-center justify-content-between infant">
                      <label class="font-size-16" style="width:100px;"><?=T::infant?> <span><!--?=T::age?--> Younger than 2 </span></label>
                      <label class="font-size-16" style="width:100px;"><?=T::price?> <span><?=$currency?> <?=$tour->b2c_price_infant?></span></label>
                      <div class="d-flex align-items-center">
                        <select name="infants" id="infants" class="infants form-select" <?php if($i_price == 0 ) {echo 'disabled';} ?>>
                          <option value="">0</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
