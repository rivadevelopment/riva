...
<input type="hidden" name="country_code" class="country_code" value="<?php if(isset($profile_data->ai_country)&& !empty($profile_data->ai_country)){ echo $profile_data->ai_country; } else { echo "IN"; } ?>" />
