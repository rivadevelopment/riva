...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-1C470E745N"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-1C470E745N');
</script>
...
<header class="header-area">
    <div class="header-top-bar padding-right-100px padding-left-100px" style="display: block;">
        <div class="container">
...
-->
   ...
   <!--                   </div>
    ...
    <!--<div class="header-top-bar padding-right-100px padding-left-100px padding-top-10px" style="background:#fff; border-bottom:1px solid #ccc;"> -->
     <!--<div class="header-menu-wrapper padding-right-100px padding-left-100px padding-top-10px"> <!-- header-fixed  header-menu-rcustom   style="border-bottom: 1px solid #ccc;" -->
    <!-- header-menu-wrapper  -->
    <div class="header-top-bar padding-right-100px padding-left-100px" style="display: block; background:#fff; border-bottom:1px solid #ccc;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="main-menu-content">
                            <nav>
                                <ul>
                                    ...
                                    <!--  </a>-->
                                    <!--</li> -->
                                    <!-- align-items-center text-center font-weight-medium -->
                                      ...
                                      <li>
                                        <div class="header-right-action pt-1 pe-2">
                                            <div class="dropdown">
                                                <a class="btn btn-default menu_cust_item" href="<?=root;?>" title="home"> 
                                                   <?=T::home?>
                                                </a>
                                            </div>
                                        </div>        
                                     ...
                                     <?php if ($app->app->multi_language == true) { ?>
                                      <li class="">
                                        <div class="header-right-action pt-1 pe-2">
                                        <div class="dropdown">
                                        <a class="btn btn-default dropdown-toggle" type="button" id="languages" data-bs-toggle="dropdown" aria-expanded="false"> 
                                        <span class="flag-icon flag-icon-<?php foreach ($files_data as $lang){ if($lang->lang_code == $session_lang){ echo $lang->country_code; } }?> mr-1"></span>
                                        <?php foreach ($files_data as $lang){ if($lang->lang_code == $session_lang){ echo $lang->language_name; } }?>
                                        </a>
                                        <ul class="dropdown-menu" aria-labelledby="languages">
                                        <?php foreach($files_data as $item)
                                               { $lan = $item->lang_code; {
                                                 if($item->language_name == 'English' || $item->language_name == 'Arabic') {?>
                                                   <li style="width:100%;">
                                                       <a class="dropdown-item" href="<?=root?>lang-<?=$item->lang_code?>"><span class="flag-icon flag-icon-<?=$item->country_code?> mr-1"></span> <?=$item->language_name?>
                                                      </a>
                                                   </li>
                                        <?php } } } ?>
                                        </ul>
                                        ...
                                        <div class="header-right-action  pt-1 pe-2">
                                        <div class="dropdown">
                                        <a class="btn btn-default dropdown-toggle" type="button" id="currency" data-bs-toggle="dropdown" aria-expanded="false">
                                        <?=$session_currency?>
                                        </a>
                                        <ul class="dropdown-menu" aria-labelledby="currency">
                                        <?php foreach ($app->currencies as $currencies){ if($currencies->status == true){ ?>
                                        <li style="width:100%;"><a class="dropdown-item" href="<?=root?>currency-<?=$currencies->name?>"> <?=$currencies->name?></a></li>
                                        <?php } } ?>
                                        </ul>
                                        </div>
                                        </div>
                                     ...
                                     <!-- customers registration and login -->
                                               ...
                                               <div class="header-right-action pt-1 pe-2">
                                                 <div class="dropdown">
                                                     <?php if( !($_SESSION['user_type'] == 'guest' || $_SESSION['user_type'] == 'customers')) 
                                                        { ?>
                                                               <a class="btn btn-default menu_cust_item" title="home" href="<?=root?>account/dashboard"> 
                                                                  <?=T::dashboard?>
                                                               </a>
                                                     <?php } else { ?> 
                                                               <a class="btn btn-default menu_cust_item" title="home" href="<?=root?>account/bookings"> 
                                                                  <?=T::myprofile?>
                                                               </a>
                                                     <?php }  ?> 
                                                 </div>
                                        ...
                                        <?php } else { ?>
                                           <li>
                                             <div class="header-right-action pt-1 pe-2">
                                                <div class="dropdown">
                                                    <a class="btn btn-default menu_cust_item" href="<?=root?>login" title="home">
                                                        <?=T::login?>
                                                    </a>
                                                </div>
                                             </div>
