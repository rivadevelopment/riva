...
dd('feas');die;
  ...
  "payment": {
    "amount": "500",
    "currency": "AED",
    "description": "booking for 23003333",
    "buyer": {
      "phone": "500000001",
    ...
    "order": {
      ...
      "reference_id": "AE349491004",
      "items": [
        {
          "title": "flight ticket",
          "description": "abu dhabi to amman",
          "quantity": 1,
          "unit_price": "500.00",
          "discount_amount": "0.00",
          "reference_id": "string",
  ...
  "merchant_code": "RVT",
  "merchant_urls": {
    "success": "https://www.rivatrip.com/success",
    "cancel": "https://www.rivatrip.com/cancel",
    "failure": "https://www.rivatrip.com/failure"
  }
}
html;
        // dd($data);die;
...
$router->get('payment/tabby-payment', function() {
  ...
  //////////////////// Webhooks feras webhoks ///////////////////////////////
        //$url = "https://api.tabby.ai/api/v1/webhooks/".$paymentid;
...
$router->get('payment/webhooks', function() {
        ...
        $req->post(api_url.'api/email/globalmail?appKey='.api_key, array(
            'name'=>$data_mail['firstname'].' '.$data_mail['lastname'],
            'email'=>'payment@rivatrip.com',
            'body'=>'send mail by ak 222233333',
            'subject'=>'Tabby Payment Email',
            'cc_mail'=>'info@rivatrip.com'
        ));
});
