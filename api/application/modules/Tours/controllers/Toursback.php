...
class Toursback extends MX_Controller {
        ...
        public  $redirectwebsitepermission = true;
		...
		function index() {
                ...
                if($this->redirectwebsitepermission){
                // dd($tour);die;
                $xcrud->button(apiurl. '/en/aed/tour/dubai/{tour_slug}/{tour_id}/'.date('d-m-Y',strtotime('+3 day')).'/1/0/0', 'web link', 'fa fa-globe', 'btn btn-success', array('target' => '_blank'));
