      ...
      <div class="panel-body">
       <div class="row form-group">
          ...
          <!-- add by ak -->
           <div class="row form-group">
            <?php if($isadmin){ ?>
            <label class="col-md-3 control-label text-left">Validity</label>
            <div class="col-md-1">
            ...
            <div class="row">
              <input class="form-control" type="datetime-local" placeholder="From validity" value="<?php if(!empty($tdata[0]->tour_validity_from)){ echo $tdata[0]->tour_validity_from; }?>" name="tour_validity_from" >
              <input class="form-control" type="datetime-local" placeholder="To validity" value="<?php if(!empty($tdata[0]->tour_validity_to)){ echo $tdata[0]->tour_validity_to; }?>" name="tour_validity_to" >
            </div>
            </div>
            ...
            <input type="hidden" name="tour_validity_from" value="">
            <input type="hidden" name="tour_validity_to" value="">
            <?php } ?>
          </div>
          <!-- end add by ak -->
           <div class="row form-group">
