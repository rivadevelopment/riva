...
// add tour data
		function add_tour($user = null) {
			if(empty($user)){
                ...
                $validity_from = $this->input->post('tour_validity_from');
		$validity_to = $this->input->post('tour_validity_to');
				...
				$data = array('tour_title' => $this->input->post('tourname'),
					...
					'tour_validity_from' => $validity_from,
					'tour_validity_to' =>$validity_to,
					'tour_owned_by' => $user,
