...
body:after {
    ...
    z-index:1;
    background: linear-gradient(45deg, #8a37e4 0, #ffaa02 99%);
    /*background-image: radial-gradient(circle farthest-side at center bottom,#ffaa02 ,#8a37e4 125%);*/
}
  ...
  <script type="text/javascript">
   ...
   <div style="z-index: 9999;margin-top:-200px;position: fixed; width: 500px; height: 200px; margin: 7% auto; /* Will not center vertically and won't work in IE6/7. */ left: 0; right: 0;">
    ...
    <form method="POST" data-wow-duration="0.2s" data-wow-delay="0.2s" class="form-signin form-horizontal wow fadeIn animated" role="form" onsubmit="return false;">
      <div>
        <img data-wow-duration="0.2s" data-wow-delay="0.2s" src="<?php echo base_url(); ?>assets/img/logo.png" class="wow fadeIn center-block" style="width:175px;height:50px;margin-bottom:25px" alt="" />
        <h2 class="form-heading text-center" style="text-transform: uppercase; letter-spacing: 5px; margin-top: 0px;"><strong>Sign in</strong></h2>
       <label class="">
