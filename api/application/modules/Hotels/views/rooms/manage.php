...
<hr>
  ...
  <div class="row form-group">
    ...
    <!-- Feras chnages -->
  <div class="row form-group">
    <label class="col-md-3 control-label text-left">No. of Beds</label>
    <div class="col-md-9">
      <input class="form-control" type="number" placeholder="Number of Beds" name="room_bed_no"  value="<?php echo @$rdata[0]->room_bed_no;?>">
    </div>
  </div>
  
   <div class="row form-group">
    <label class="col-md-3 control-label text-left">Bed Type</label>
    <div class="col-md-9">

    <select class="form-control room_bed_type" name="room_bed_type">
      ...
      <script>
      $('.room_bed_type option[value="<?php echo @$rdata[0]->room_bed_type;?>"]').attr('selected', 'selected');
      </script>
      
      <!-- <script>-->
      <!--$('.room_bed_type option[value="Queen Bed"').attr('selected', 'selected');-->
      <!--</script>-->
  ...
  <div class="row form-group">
    <label class="col-md-3 control-label text-left">No. of Bathroom</label>
    <div class="col-md-9">
      <input class="form-control" type="number" placeholder="Number of Bathroom" name="room_bath_no"  value="<?php echo @$rdata[0]->room_bath_no;?>">
    </div>
  </div>
  
  <div class="row form-group">
    <label class="col-md-3 control-label text-left">Room Size</label>
    <div class="col-md-9">
      <input class="form-control" type="number" placeholder="Room Size" name="room_size"  value="<?php echo @$rdata[0]->room_size;?>">
    </div>
  </div>
