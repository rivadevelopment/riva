...
$extrabeds = $this->input->post('extrabeds');
   ...
   $data = array(
            ...
            'room_bed_no' => intval($this->input->post('room_bed_no')),
            
            'room_bed_type' => $this->input->post('room_bed_type'),
            
            'room_bath_no' => intval($this->input->post('room_bath_no')),
            
            'room_size' => floatval($this->input->post('room_size')),
